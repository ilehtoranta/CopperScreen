...
Updated: 2026-09-16. This is the current bounded completion checklist; historical
...
The production solution is `CopperScreen.slnx`; engine timing tests use the
isolated diagnostic command in the [README](../../../README.md#tests-and-headless-execution).
...
fingerprints. See [commit-isolation evidence](../migration/LIGHTWEIGHT_COMMIT_ISOLATION_2026-09-16.md).
...
The standard startup profile is the native A500 configuration above. Legacy
remains represented as an explicit selection in Settings and on the command
line, but reports unavailable when requested; typed Legacy test/benchmark entry
points retain their historical defaults. Unsupported
