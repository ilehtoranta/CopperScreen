...
# Homogeneous retention v2: accepted d403d35 reference and post-ERSY native
...
public static class HomogeneousTopologyV2 {
...
try {
    ...
    if ((Get-FileHash "$reference/CopperMod.Amiga.Lightweight.dll").Hash -ne
        ...
        throw 'This comparison requires the accepted d403d35 reference.'
    }
    ...
    $topology = @([HomogeneousTopologyV2]::Read() | ForEach-Object {
    ...
    "PROTOCOL homogeneous-retention-v2; Normal; CPU=$LogicalProcessor; protected=$($protected -join ','); six balanced pairs/workload; matching complete-workload identities"
