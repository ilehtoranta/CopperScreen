...
# Homogeneous retention v3: accepted 6651307 reference and post-ERSY native
...
public static class HomogeneousTopologyV3 {
...
try {
    ...
    if ((Get-FileHash "$reference/CopperMod.Amiga.Lightweight.dll").Hash -ne
        ...
        throw 'This comparison requires the accepted 6651307 reference.'
    }
    ...
    $topology = @([HomogeneousTopologyV3]::Read() | ForEach-Object {
    ...
    "PROTOCOL homogeneous-retention-v3; Normal; CPU=$LogicalProcessor; protected=$($protected -join ','); six balanced pairs/workload; matching complete-workload identities"
