...
# OCS absent-DENISEID comparison v3: pre-change engine versus cached bus word and fixed-size DMA word access.
...
public static class OcsIdentificationTopologyV3 {
...
try {
    ...
    $topology = @([OcsIdentificationTopologyV3]::Read() | ForEach-Object {
    ...
    "PROTOCOL ocs-identification-comparison-v3; Normal; CPU=$LogicalProcessor; protected=$($protected -join ','); six balanced pairs/workload; all workload identities identical across builds"
