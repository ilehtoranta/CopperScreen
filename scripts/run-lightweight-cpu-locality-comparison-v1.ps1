...
# CPU prefetch locality comparison v1: accepted 9be9fee engine versus three
# Copper68k prefetch inlining boundaries. Timing, placement, host policy, six-pair design and
# workload identities are unchanged from live-WORDSYNC comparison v1.
# See docs/engine/CPU_PREFETCH_LOCALITY_2026-09-22.md.
...
public static class CpuPrefetchLocalityTopologyV1 {
...
try {
    ...
    $topology = @([CpuPrefetchLocalityTopologyV1]::Read() | ForEach-Object {
    ...
    "PROTOCOL cpu-prefetch-locality-comparison-v1; Normal; CPU=$LogicalProcessor; protected=$($protected -join ','); six balanced pairs/workload; all workload identities identical across builds"
