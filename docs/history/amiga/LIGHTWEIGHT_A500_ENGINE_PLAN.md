...
Use `CopperScreen.slnx` for the production build. Run engine timing tests with
the isolated diagnostic command in the [README](../../../README.md#tests-and-headless-execution).
Historical paths and gate results below are unchanged.
...
falling back. Use the production solution and isolated diagnostic command
documented in the [README](../../../README.md#tests-and-headless-execution); see
[restoration boundary](../../../CopperScreen/COPPERSTART_RESTORATION.md).
...
## Historical staged execution record

The dated status and gate entries below retain contemporaneous decisions and
evidence. Routing statements that predate the 2026-09-15 default-switch
authorization are historical; the current routing is defined in the decision
block above and in [Supported-v1 readiness](LIGHTWEIGHT_A500_SUPPORTED_V1_READINESS.md).
...
at the time of this historical record, Legacy/default routing was unchanged;
...
complete Amiga emulator. At the time of this historical record, CopperScreen
supported explicit experimental selection with Legacy as the default; that
routing state is superseded by the current decision above.
...
The three projects were included in the historical `CopperMod.sln`. The runner accepts an
...
not rerun or relabel the historical Legacy comparison. **Historical Stage 4
disposition, recorded before the 2026-09-15 default switch: Stage 4 was opt-in /
OPEN pending live verification; Legacy was the default.** Current routing is
recorded at the top of this document and in Supported-v1 readiness.
