...
# Homogeneous retention v4: accepted a10b22c reference and post-ERSY native
...
public static class HomogeneousTopologyV4 {
...
try {
    ...
    if ((Get-FileHash "$reference/CopperMod.Amiga.Lightweight.dll").Hash -ne
        ...
        throw 'This comparison requires the accepted a10b22c reference.'
    }
    ...
    $topology = @([HomogeneousTopologyV4]::Read() | ForEach-Object {
